  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <main className="relative flex-1 flex">
        <aside className="w-[460px] bg-[#fbe3b9] border-r border-[#e6c9a4] px-10 py-12 flex flex-col relative overflow-hidden">
          ...
          {/* ✅ ONLY UPDATED: book-flower fixed position */}
          <img
            src="/images/Book-flower.png"
            alt="Book with flowers"
            className="absolute left-10 bottom-10 w-[380px] h-auto pointer-events-none select-none"
          />
        </aside>
